package com.learning.ui.component.chart;
...
public class CandleStickChart extends ApexChartsBuilder {
    public CandleStickChart() {
        withChart(ChartBuilder.get()
                ...
                .build())
                .withSeries(getCoordinateSeries())
    ...
    private Series<Coordinate<String, BigDecimal>> getCoordinateSeries() {
        return new Series<>(
    ...
    public String getISOString(long l) {
        return LocalDateTime.ofInstant(Instant.ofEpochMilli(l),
